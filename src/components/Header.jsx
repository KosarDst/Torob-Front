  ...
  return (
    <div className="header">
      <div className="menu">
        <span className="menu-title mobile-title">
          ...
          <ul className={`list-item ${isMobile ? "mobile" : null}`}>
            ...
            <Link to="searchresults/mobile/post">
              <h3 name="mobile">موبایل</h3>
            </Link>
            {mobile.map((phone) => {
              return (
                <Link
                  to={`searchresults/${phone.category.categ}/post`}
                >
                  <li
                    key={phone.id}
            ...
            <Link to="searchresults/tablet/post">
              <h3 name="tablet">تبلت</h3>
            </Link>
            {tablet.map((tab) => {
              return (
                <Link
                  to={`searchresults/${tab.category.categ}/post`}
                >
        ...
        <span className="menu-title laptop-title">
          ...
          <ul className={`list-item ${isLaptop ? "laptop" : null}`}>
            <Link to="searchresults/laptop/post">
            ...
            {laptop.map((lab) => {
              return (
                <Link
                  to={`searchresults/${lab.category.categ}/post`}
                >
      ...
      <div className="register-cta">
        <Link to={`${user.username !== null ? "/userprofile" : "/register"}`}>
          <button>
            {user.username !== null ? "حساب" : " ورود / ثبت نام"}{" "}
          </button>
        </Link>
      </div>
    </div>
