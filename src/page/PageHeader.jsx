...
import { allProduct, selectUser } from "../features/userSlice";
      ...
      <div className="menu">
        <span className="menu-title mobile-title">
          ...
          <ul className={`list-item ${isMobile ? "mobile" : null}`}>
            <Link to="/searchresults/mobiletablet/all">
              <p>موبایل و تبلت</p>
            </Link>
            <Link to="/searchresults/mobile/all">
            ...
            <Link to="/searchresults/tablet/all">
        ...
        <span className="menu-title laptop-title">
          ...
          <ul className={`list-item ${isLaptop ? "laptop" : null}`}>
            <Link to="/searchresults/laptop/all">
